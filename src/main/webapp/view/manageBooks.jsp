...
<div class="home">
    <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="images/manageBooks.jpg"
         data-speed="0.8"></div>
    <div class="home_container">
        <div class="home_content">
            <div class="home_title text-white text-center"
                 style="font-family: Lucida Handwriting; font-size: 100px; padding-top: 200px;">
...
<div class="container" style="background-color: #dddddd; margin-bottom: 2%;">
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover table-dark">
            ...
            <tr style="background-color: #cff6cf;">
                <th scope="col">#Id</th>
            ...
            <c:forEach var="book" items="${books}">
                <tr class="record">
                    ...
                    <td>
                        <div class="row">
                            <div class="col">
                                <button class="btn btn-primary btn-sm" title="Edit Book" onclick="location.href ='${contextPath}/books/edit/${book.id}'">
